...
function createMap(sparqlEndpoint, encoded_query, mapid, idx = 0, waitfilters = true, color_code) {
    $.ajax({
        ...
        success: function (returnedJson) {
            ...
            setView(mapid, geoJSONdata, waitfilters, color_code);
        },
        complete: function () {
...
function setView(mapid, geoJSONdata, waitfilters, color_code) {
    ...
    var markers = L.markerClusterGroup({
        iconCreateFunction: function (cluster) {
            ...
            return L.divIcon({ html: "<span class='pointer-color' style='" + innerClusterStyle + ";'>" + n + "</span>", className: 'mycluster', iconSize: L.point(40, 40) });
        },
